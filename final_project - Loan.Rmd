...
by(subset(df,ratio_monthly_loan_payment<=0.5 & !is.na(CreditScoreRangeMid))$ratio_monthly_loan_payment, subset(df,ratio_monthly_loan_payment<=0.5 & !is.na(CreditScoreRangeMid))$CreditScoreRangeMid, summary)
```
